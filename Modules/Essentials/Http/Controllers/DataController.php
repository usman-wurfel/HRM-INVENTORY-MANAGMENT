...
class DataController extends Controller
{
    ...
    public function user_permissions()
    {
        return [
            ...
            [
                'value' => 'essentials.crud_holiday',
                'label' => __('essentials::lang.crud_holiday'),
                'default' => false,
            ],
            ...
            [
                'value' => 'essentials.loan_request',
                'label' => __('essentials::lang.loan_request'),
                'default' => false,
            ],
            [
                'value' => 'essentials.loan_manage',
                'label' => __('essentials::lang.loan_manage'),
                'default' => false,
            ],
        ];
    }
