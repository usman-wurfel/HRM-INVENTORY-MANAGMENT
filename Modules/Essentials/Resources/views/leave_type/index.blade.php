...
@endsection
    ...
    <script type="text/javascript">
        // Translation strings
        var lang_saving = "{{ __('messages.saving') }}";
        var lang_something_went_wrong = "{{ __('messages.something_went_wrong') }}";
        ...
        $(document).on('submit', 'form#add_leave_type_form, form#edit_leave_type_form', function (e) {
            ...
            $.ajax({
                ...
                error: function() {
                    toastr.error(lang_something_went_wrong);
                },
                complete: function() {
        ...
        // Enable button when modal is opened
        $('#add_leave_type_modal').on('shown.bs.modal', function() {
            var submitBtn = $(this).find('button[type="submit"]');
            submitBtn.prop('disabled', false);
        });

        // Enable button when modal is hidden
        $('#add_leave_type_modal').on('hidden.bs.modal', function() {
            var submitBtn = $(this).find('button[type="submit"]');
            submitBtn.prop('disabled', false);
        });
    </script>
