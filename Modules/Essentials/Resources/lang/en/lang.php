...
return [
    ...
    'version_info' => 'Essentials and HRM module version - <code> :version </code>',
        ...
        'rejected' => 'Rejected',
        'crud_holiday' => 'Manage Holiday',
        'holiday_type' => 'Holiday Type',
        'normal' => 'Normal',
        'consecutive_holidays' => 'Consecutive Holidays',
        'repeat_type' => 'Repeat Type',
        'week' => 'Week',
        'month' => 'Month',
        'weekdays' => 'Week Days',
        'month_days' => 'Month Days',
        'month_days_placeholder' => 'e.g., 1,15,30 (comma separated)',
        'month_days_help' => 'Enter days of month separated by comma (e.g., 1,15,30)',
        'custom_dates' => 'Custom Dates',
        'custom_dates_placeholder' => 'Select dates from calendar',
        'custom_dates_help' => 'Click to select specific dates for this holiday',
        'repeat_pattern' => 'Repeat Pattern',
        'every_week' => 'Every Week',
        'alternate_week' => 'Alternate Week',
        'gap_weeks' => 'Gap After Weeks',
