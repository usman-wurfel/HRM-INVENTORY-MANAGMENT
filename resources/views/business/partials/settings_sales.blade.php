<div class="pos-tab-content">
    ...
    <!-- Hidden fields for removed payment link settings -->
    {!! Form::hidden('pos_settings[enable_payment_link]', 0); !!}
    {!! Form::hidden('pos_settings[razor_pay_key_id]', ''); !!}
    {!! Form::hidden('pos_settings[razor_pay_key_secret]', ''); !!}
    {!! Form::hidden('pos_settings[stripe_public_key]', ''); !!}
    {!! Form::hidden('pos_settings[stripe_secret_key]', ''); !!}
</div>