                        ...
                        <a href="{{ url('/') }}">
                            <div
                                ...
                                @if(!empty($business_logo))
                                    <img src="{{ $business_logo }}" alt="logo" class="tw-object-fill" style="max-width: 100%; height: auto;" />
                                @else
                                    <img src="{{ asset('img/logo-small.png')}}" alt="lock" class="tw-object-fill" style="max-width: 100%; height: auto;" />
                                @endif
                            </div>
                        </a>
