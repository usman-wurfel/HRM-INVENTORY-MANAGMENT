<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::hidden('default_payment_accounts', !empty($transaction->location) && !empty($transaction->location->default_payment_accounts) ? $transaction->location->default_payment_accounts : '{}', ['id' => 'default_payment_accounts']); !!}
