            ...
            <div
                ...
                <div class="tw-flex tw-flex-col tw-gap-4 tw-dw-rounded-box tw-dw-p-6 tw-dw-max-w-md">
                    ...
                    <form method="POST" action="{{ route('login') }}" id="login-form">
                                ...
                                <div class="tw-dw-label">
                                    ...
                                    @if (config('app.env') != 'demo')
                                        <a href="{{ route('password.request') }}"
                                            class="tw-text-xs md:tw-text-sm tw-font-medium tw-text-[#fce218] hover:tw-text-[#fce218]"
                        ...
                        @endif
                        <button type="submit"
                            style="background-color: #e8041c; color: white;"
                            class="tw-h-12 tw-rounded-xl tw-text-sm md:tw-text-base tw-font-semibold tw-w-full tw-max-w-full mt-2 hover:opacity-90 focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-[#e8041c] focus:tw-ring-offset-2 active:opacity-80"
                            onmouseover="this.style.backgroundColor='#d00418'"
                            onmouseout="this.style.backgroundColor='#e8041c'"
                            onmousedown="this.style.backgroundColor='#b80314'"
                            onmouseup="this.style.backgroundColor='#e8041c'">
                            @lang('lang_v1.login')
                        </button>
                    </form>
                        ...
                        @if (!($request->segment(1) == 'business' && $request->segment(2) == 'register'))
                            ...
                            @if (config('constants.allow_registration'))
                                <a href="{{ route('business.getRegister') }}@if (!empty(request()->lang)) {{ '?lang=' . request()->lang }} @endif"
                                    ...
                                    <span
                                        class="tw-text-sm tw-font-medium tw-text-[#fce218] hover:tw-text-[#fce218] hover:tw-underline">{{ __('business.register_now') }}</span></a>
                            @endif
                        @endif
                    </div>
                </div>
