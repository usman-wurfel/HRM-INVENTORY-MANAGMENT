                                      ...
                                      @foreach($user->documents as $document)
                                        <tr>
                                          ...
                                          <td>
                                            ...
                                            @can('user.update')
                                              <form action="{{ action([\App\Http\Controllers\ManageUserController::class, 'deleteDocument'], [$document->id]) }}" method="POST" style="display: inline;" class="delete-document-form">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-xs btn-danger delete-document-btn" onclick="return confirm('{{ __('messages.are_you_sure') }}');">
