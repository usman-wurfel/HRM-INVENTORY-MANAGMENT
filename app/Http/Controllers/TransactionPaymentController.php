    ...
    public function store(Request $request)
    {
        try {
            ...
            if ($transaction->payment_status != 'paid') {
                ...
                // Auto-create expense entry if payment is paid or partial (for purchase/return)
    ...
    public function addPayment($transaction_id)
    {
        ...
        if (request()->ajax()) {
            ...
            if ($transaction->payment_status != 'paid') {
                ...
                if (in_array($transaction->type, ['expense', 'expense_refund']) && (empty($transaction->location) || empty($transaction->location->default_payment_accounts))) {
