...
class SellController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            $datatable = Datatables::of($sells)
                ->addColumn(
                    ...
                    function ($row) use ($only_shipments, $is_admin, $sale_type, $is_zatca) {
                        ...
                        if ($row->type == 'sell') {
                            // Hide print invoice, packing slip, delivery note
                            ...
                            if (! $only_shipments) {
                                ...
                                if (auth()->user()->can('sell.create') || auth()->user()->can('direct_sell.access')) {
                                    ...
                                    // Hide sell return and view invoice URL
            ...
            $rawColumns = ['final_total', 'action', 'total_paid', 'total_remaining', 'payment_status', 'invoice_no', 'discount_amount', 'tax_amount', 'total_before_tax', 'types_of_service_name', 'payment_methods', 'conatct_name', 'status', 'zatca_status'];
