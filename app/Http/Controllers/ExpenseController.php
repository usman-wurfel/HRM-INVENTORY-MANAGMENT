    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($expenses)
                ...
                ->removeColumn('c_id')
                ->removeColumn('is_recurring')
                ->removeColumn('recur_interval')
                ->removeColumn('recur_interval_type')
                ->removeColumn('recur_repetitions')
                ->removeColumn('subscription_repeat_on')
                ->removeColumn('recur_parent_id')
                ->addColumn(
                    'action',
                    '<div class="btn-group">
