...
class PurchaseController extends Controller
{
    ...
    public function index()
    {
        ...
        // Use same query as contacts page (https://myportal.pt/contacts?type=supplier)
        $suppliers_query = Contact::leftjoin('transactions AS t', 'contacts.id', '=', 't.contact_id')
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $transaction_data['discount_type'] = $transaction_data['discount_type'] ?? '';
            ...
            // Auto-create expense entry if payment is paid or partial
            $this->transactionUtil->autoCreateExpenseFromPurchase($transaction);
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            // Set default values for removed fields
            $update_data['discount_type'] = $update_data['discount_type'] ?? '';
            $update_data['discount_amount'] = $update_data['discount_amount'] ?? 0;
            $update_data['tax_id'] = $update_data['tax_id'] ?? null;
