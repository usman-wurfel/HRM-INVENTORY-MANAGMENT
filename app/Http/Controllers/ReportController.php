    ...
    public function getCashFlow(Request $request)
    {
        ...
        $query = Transaction::where('transactions.business_id', $business_id)
            ...
            ->select(
                ...
                DB::raw("CONCAT(COALESCE(u.surname, ''),' ',COALESCE(u.first_name, ''),' ',COALESCE(u.last_name,'')) as entry_by")
            )
        ...
        foreach ($transactions as $transaction) {
            ...
            if ($transaction->type == 'sell' && $transaction->payment_status != 'due') {
                // Get actual paid amount for sales
                ...
                $cash_in = $transaction->final_total;
                $total_cash_in += $cash_in;
            }
        ...
        $final_balance = $total_cash_in - $total_cash_out;

        return view('report.cash_flow', compact(
            'business_locations',
            'cash_flow_data',
            'total_cash_in',
            'total_cash_out',
