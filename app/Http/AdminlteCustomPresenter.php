...
class AdminlteCustomPresenter extends Presenter
{
    ...
    {
        return '<div class="tw-flex-1 tw-p-3 tw-space-y-3 tw-overflow-y-auto tw-border-r tw-border-gray-200 tw-bg-white" id="side-bar" style="min-height: calc(100vh - 4rem);">' . PHP_EOL;
    }
