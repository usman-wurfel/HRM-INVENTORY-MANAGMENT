...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('users/{id}/document/download', [ManageUserController::class, 'downloadDocument'])->name('users.document.download');
    Route::get('users/{id}/document/view', [ManageUserController::class, 'viewDocument'])->name('users.document.view');
    Route::delete('users/{id}/document/delete', [ManageUserController::class, 'deleteDocument'])->name('users.document.delete');
